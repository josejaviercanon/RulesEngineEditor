...
namespace RulesEngine.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260529233514_AddRuleExecuteOrder")]
    partial class AddRuleExecuteOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RulesEngine.Infrastructure.Persistence.Entities.RuleRecord", b =>
                {
                    ...
                    b.ToTable("rules", null, t =>
                        {
                            t.HasCheckConstraint("CK_rules_Status", "\"Status\" IN ('draft', 'failed', 'disabled', 'production')");
                        });
                });
